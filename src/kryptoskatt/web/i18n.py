...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "Beräkna": "Calculate",
        "Mer": "More",
        "Så räknar vi": "How we calculate",
        "Användarvillkor": "Terms of use",
        "Integritetspolicy": "Privacy policy",
        "Juridisk information": "Legal information",
        "KryptoSkatt är ett hjälpmedel, inte skatterådgivning. Du ansvarar själv för din deklaration — kontrollera alltid resultatet.": "KryptoSkatt is a calculation aid, not tax advice. You are responsible for your own tax return — always check the result.",
        "Vinster": "Gains",
        "Förluster": "Losses",
        "Netto": "Net",
